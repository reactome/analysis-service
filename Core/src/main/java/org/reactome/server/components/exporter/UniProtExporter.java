...
public class UniProtExporter {
    ...
    public void export(MySQLAdaptor dba){
        //THIS IS NEEDED HERE
        ...
        for (PhysicalEntityNode node : analysisData.getPhysicalEntityGraph().getRootNodes()) {
            uniprotToPathways.addAll(getUniProtToPathways(node));
        }
