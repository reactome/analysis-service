...
public class PhysicalEntityNode {
    ...
    private MapSet<Long, Long> pathwayReactions = null;
    ...
    public void addPathwayReactions(MapSet<Long, Long> pathwayReactions){
        if(this.pathwayReactions==null){
            this.pathwayReactions = new MapSet<Long, Long>();
        }
    ...
    public Set<Long> getReactions(Long pathwayId){
        Set<Long> rtn = new HashSet<Long>();
        if(this.pathwayReactions!=null){
            Set<Long> reactions = this.pathwayReactions.getElements(pathwayId);
            if(reactions!=null){
